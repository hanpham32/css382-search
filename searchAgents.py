    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                successors.append(((nextState, tuple(nextVisitedCorners)), action, 1))
...
def cornersHeuristic(state, problem):
    ...
    unvisited_corners = []
    for corner, visited in zip(problem.corners, visited_corners):
        if not visited:
    ...
    while unvisited_corners:
        ...
        unvisited_corners.remove(nearestCorner)
...
def foodHeuristic(state, problem):
    ...
    for food in foods:
        dist = max(dist, mazeDistance(food, position, problem.startingGameState))
    return dist
